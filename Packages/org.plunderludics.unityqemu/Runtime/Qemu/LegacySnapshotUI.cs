...
/// Session-only; prefer <see cref="SnapshotUI"/> for durable <c>.uqsnap</c> snapshots.
/// </summary>
[ExecuteAlways]
public class LegacySnapshotUI : MonoBehaviour
{
    ...
    public class SnapshotEntry
    {
        ...
        [NonSerialized] public LegacySnapshotUI owner;
